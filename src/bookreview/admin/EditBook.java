...
public class EditBook extends javax.swing.JFrame {
    ...
    public EditBook(String title, String isbn, String categoryname, String firstname, String lastname, String originalTitle) {
        initComponents();
        conn = new Connect();
        txtTitle.setBackground(new java.awt.Color(0,0,0,1));
        txtCategory.setBackground(new java.awt.Color(0,0,0,1));
    ...
    private void btnConfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmActionPerformed
        ...
        if (title.isEmpty() || isbn.isEmpty() || category.isEmpty() || firstname.isEmpty() || lastname.isEmpty()) {
            JOptionPane.showMessageDialog(null, "Please fill in all fields");
            return;
        }
        if(title.equals(originalTitle)) {
            boolean success = conn.updateBook(title, isbn, category, firstname, lastname, false);
        }
        boolean success = conn.updateBook(title, isbn, category, firstname, lastname, true);
        ...
        if (success) {
            ...
            JOptionPane.showMessageDialog(null, "Failed to update book. Please try again.");
        }
